import {
  Typography_default
} from "./chunk-WYO2YETK.js";
import "./chunk-ELYBLC6M.js";
import "./chunk-FMFFUJ5P.js";
import {
  useTheme
} from "./chunk-2VOBGGIP.js";
import {
  NoSsr,
  Popper,
  useSlotProps
} from "./chunk-WBHCZOFQ.js";
import {
  require_react_dom
} from "./chunk-CXJOIMMF.js";
import "./chunk-DJBG3EE3.js";
import "./chunk-MEV26MAT.js";
import {
  Box_default,
  _extends,
...
var useCompletedData = () => {
  ...
  const seriesData = (_React$useContext$bar = React12.useContext(SeriesContext).bar) != null ? _React$useContext$bar : {
    series: {},
    stackingGroups: [],
    seriesOrder: []
  };
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React19.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React20.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
    ...
    children: [!disableLine && (0, import_jsx_runtime15.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime16.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime15.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && (0, import_jsx_runtime15.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
...
true ? ChartsAxis.propTypes = {
  ...
  bottomAxis: import_prop_types8.default.oneOfType([import_prop_types8.default.shape({
    axisId: import_prop_types8.default.string,
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types10.default.shape({
    ...
    series: import_prop_types10.default.shape({
      ...
      data: import_prop_types10.default.arrayOf(import_prop_types10.default.number).isRequired,
...
function DefaultChartsLegend(props) {
  ...
  const seriesWithPosition = React29.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
...
function ChartsLegend(inProps) {
  ...
  const drawingArea = React29.useContext(DrawingContext);
...
var BarChart = React33.forwardRef(function BarChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime32.jsxs)(ResponsiveChartContainer, {
    ref,
    ...
    children: [(0, import_jsx_runtime31.jsx)("g", {
      clipPath: `url(#${clipPathId})`,
      children: (0, import_jsx_runtime31.jsx)(BarPlot, {
        slots,
        slotProps,
        skipAnimation: skipAnimation2
      })
    }), (0, import_jsx_runtime31.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime31.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime31.jsx)(ChartsAxisHighlight, _extends({}, defaultizedAxisHighlight)), (0, import_jsx_runtime31.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), (0, import_jsx_runtime31.jsx)(ChartsClipPath, {
      id: clipPathId
    }), children]
  });
});
true ? BarChart.propTypes = {
   ...
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types16.default.oneOfType([import_prop_types16.default.shape({
    axisId: import_prop_types16.default.string,
  ...
  layout: import_prop_types16.default.oneOf(["horizontal", "vertical"]),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types16.default.oneOfType([import_prop_types16.default.shape({
    axisId: import_prop_types16.default.string,
    classes: import_prop_types16.default.object,
    disableLine: import_prop_types16.default.bool,
    disableTicks: import_prop_types16.default.bool,
   ...
   * @default null
   */
  rightAxis: import_prop_types16.default.oneOfType([import_prop_types16.default.shape({
    axisId: import_prop_types16.default.string,
    classes: import_prop_types16.default.object,
    disableLine: import_prop_types16.default.bool,
    disableTicks: import_prop_types16.default.bool,
  ...
  series: import_prop_types16.default.arrayOf(import_prop_types16.default.shape({
    color: import_prop_types16.default.string,
    data: import_prop_types16.default.arrayOf(import_prop_types16.default.number),
    ...
    label: import_prop_types16.default.string,
    layout: import_prop_types16.default.oneOf(["horizontal", "vertical"]),
    stack: import_prop_types16.default.string,
    stackOffset: import_prop_types16.default.oneOf(["diverging", "expand", "none", "silhouette", "wiggle"]),
    stackOrder: import_prop_types16.default.oneOf(["appearance", "ascending", "descending", "insideOut", "none", "reverse"]),
    type: import_prop_types16.default.oneOf(["bar"]),
    valueFormatter: import_prop_types16.default.func,
    xAxisKey: import_prop_types16.default.string,
    yAxisKey: import_prop_types16.default.string
  })).isRequired,
  /**
   * If `true`, animations are skiped.
   * @default false
   ...
   * @default null
   */
  topAxis: import_prop_types16.default.oneOfType([import_prop_types16.default.shape({
    axisId: import_prop_types16.default.string,
    classes: import_prop_types16.default.object,
    disableLine: import_prop_types16.default.bool,
    disableTicks: import_prop_types16.default.bool,
...
var _excluded9 = ["id", "classes", "color", "highlightScope", "slots", "slotProps"];
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(Area, _extends({}, areaProps));
}
...
function AreaPlot(props) {
  ...
  const seriesData = React35.useContext(SeriesContext).line;
  ...
  return (0, import_jsx_runtime34.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        return !!series[seriesId].area && (0, import_jsx_runtime34.jsx)(AreaElement, {
          id: seriesId,
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(Line, _extends({}, lineProps));
}
...
function LinePlot(props) {
  ...
  const seriesData = React37.useContext(SeriesContext).line;
...
var _excluded13 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "highlightScope"];
...
function MarkElement(props) {
  ...
  return (0, import_jsx_runtime37.jsx)(MarkElementPath, _extends({}, other, {
    ownerState,
    className: classes.root,
...
true ? MarkElement.propTypes = {
   ...
   */
  shape: import_prop_types21.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]).isRequired
} : void 0;
...
function MarkPlot(props) {
  ...
  const defaultXAxisId = xAxisIds[0];
  const defaultYAxisId = yAxisIds[0];
  return (0, import_jsx_runtime38.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ids: groupIds
    }) => {
      return groupIds.flatMap((seriesId) => {
        ...
        return xData == null ? void 0 : xData.map((x2, index2) => {
          ...
          return (0, import_jsx_runtime38.jsx)(Mark, _extends({
            id: seriesId,
            dataIndex: index2,
            shape: "circle",
            color: series[seriesId].color,
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime39.jsx)(HighlightElement, _extends({}, other, {
    ownerState,
    className: classes.root,
    cx: 0,
    cy: 0,
...
var LineChart = React42.forwardRef(function LineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime42.jsxs)(ResponsiveChartContainer, {
    ...
    sx,
    disableAxisListener: (tooltip == null ? void 0 : tooltip.trigger) !== "axis" && (axisHighlight == null ? void 0 : axisHighlight.x) === "none" && (axisHighlight == null ? void 0 : axisHighlight.y) === "none",
    children: [(0, import_jsx_runtime42.jsxs)("g", {
      clipPath: `url(#${clipPathId})`,
      children: [(0, import_jsx_runtime41.jsx)(AreaPlot, {
        slots,
        slotProps
      }), (0, import_jsx_runtime41.jsx)(LinePlot, {
        slots,
        slotProps
      })]
      ...
      slots,
      slotProps
    }), (0, import_jsx_runtime41.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime41.jsx)(MarkPlot, {
      slots,
      slotProps
    }), (0, import_jsx_runtime41.jsx)(LineHighlightPlot, {
      slots,
      slotProps
    }), (0, import_jsx_runtime41.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime41.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
...
true ? LineChart.propTypes = {
  ...
  bottomAxis: import_prop_types25.default.oneOfType([import_prop_types25.default.shape({
    axisId: import_prop_types25.default.string,
   ...
   */
  disableLineItemHighlight: import_prop_types25.default.bool,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   * @default undefined
   */
  ...
  series: import_prop_types25.default.arrayOf(import_prop_types25.default.shape({
    ...
    connectNulls: import_prop_types25.default.bool,
    ...
    disableHighlight: import_prop_types25.default.bool,
    ...
    label: import_prop_types25.default.string,
    showMark: import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.bool]),
    ...
    type: import_prop_types25.default.oneOf(["line"]),
...
var SparkLineChart = React43.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    width,
    height,
  ...
  return (0, import_jsx_runtime44.jsxs)(ResponsiveChartContainer, {
    ref,
    series: [_extends({
      type: plotType,
      data,
    ...
    children: [plotType === "bar" && (0, import_jsx_runtime43.jsx)(BarPlot, {
      slots,
      slotProps,
      sx: {
        shapeRendering: "auto"
      }
    }), plotType === "line" && (0, import_jsx_runtime44.jsxs)(React43.Fragment, {
      children: [(0, import_jsx_runtime43.jsx)(AreaPlot, {
        slots,
        slotProps
      }), (0, import_jsx_runtime43.jsx)(LinePlot, {
        slots,
        slotProps
      }), (0, import_jsx_runtime43.jsx)(LineHighlightPlot, {
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime43.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), showTooltip && (0, import_jsx_runtime43.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slotProps,
      slots
    })), children]
  });
...
true ? SparkLineChart.propTypes = {
  ...
  xAxis: import_prop_types26.default.shape({
    axisId: import_prop_types26.default.string,
    classes: import_prop_types26.default.object,
